...
<html>
    <head>
        ...
        <title>Garbismicedio | Request accepted!</title>
        <link href="https://fonts.googleapis.com/css2?family=Cormorant:ital,wght@0,300..700;1,300..700&display=swap" rel="stylesheet">
        <link href="https://fonts.googleapis.com/css2?family=Fraunces:ital,opsz,wght@0,9..144,100..900;1,9..144,100..900&display=swap" rel="stylesheet">
        <meta property="og:title" content="Garbismicedio | Request accepted!" />
        <meta property="og:image" content="site-logo.svg"/>
        
        <meta property="og:description" content="Garbismicedio | Request accepted!">
        <meta name="description" content="Garbismicedio | Request accepted!">
        <meta name="twitter:title" content="Garbismicedio | Request accepted!">
    ...
    <body>
        ...
        <header class="header-sp item--footerfw">
            <div class="container-sp">
                <div class="nav-inner-sp flex-row">
                    <a class="logo-link-sp link" href="./">
                        <img class="logo-link-sp__img" src="site-logo.png" width="37px" alt="">Garbismicedio
                    </a>
                        ...
                        <nav class="mob-nav-bar-sp">
                            <ul class="mob-nav-bar-sp__list list">
                                <li class="mob-nav-bar-sp__item">
                                    <a class="mob-nav-bar-sp__link link" href="./">Home</a>
                                </li>
                                
                                <li class="mob-nav-bar-sp__item">
                                    <a class="mob-nav-bar-sp__link link" href="./#comments">Comments</a>
                                </li>
                    ...
                    <nav class="nav-bar-sp">
                        <ul class="nav-bar-sp__list list">
                            <li class="nav-bar-sp__item">
                                <a class="nav-bar-sp__link link" href="./">Home</a>
                            </li>
                            
                            <li class="nav-bar-sp__item">
                                <a class="nav-bar-sp__link link" href="./#comments">Comments</a>
                            </li>
       ...
       <section class="hero-area-sp stock-menuiz">
            ...
            <stop stop-color="#006F5F"></stop>
            <stop offset="1" stop-color="#006F5F" stop-opacity="0"></stop>
            </linearGradient>
            ...
            <stop offset="0.145833" stop-color="#006F5F" stop-opacity="0"></stop>
            <stop offset="1" stop-color="#006F5F" stop-opacity="0.08"></stop>
            </radialGradient>
            ...
            <svg class="hero-bg-el-2" width="364" height="201" viewBox="0 0 364 201" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <stop stop-color="#006F5F" stop-opacity="0"></stop>
                <stop offset="1" stop-color="#006F5F"></stop>
                </linearGradient>
            ...
            <div class="container-sp">
                <div class="hero-inner-sp">
                    <h2 class="welcome-title-sp">Expert Clothing Alterations and Individual Styling</h2>
...
<style>
	* {
	...
	.bodyClass1-orderefg--form{
		background: #ffffff;
		color: #ffffff;
	}
	.bodyClass2-orderefg--form{
		background: #fff;
		color: #fff;
	}
	.bodyClass3-orderefg--form{
		background: #fff;
		color: #111;
	}
	.wrapage-block-orderefg--form{
		background-size: 100%;
		width: 100%;
	}
	.box_main-orderefg--form{
		width: 100%;
		margin: 0 auto;
		text-align: center;
		display: flex;
	...
	.box_main-orderefg--form h2{
		font-size: 24px;
		padding: 0px 0px 25px;
	}
	.box_main-orderefg--form p{
		font-weight: 500;
		font-size: 18px;
	}
	p{
	...
	.mainBlock-orderefg--form{
		text-align: start;
	}
	.mainBlock-orderefg--form ul{
		text-align: start;
		padding: 20px;
		display: flex;
	...
	.mainBlock-orderefg--form ul>li span{
		font-weight: bold;
	}
	.mainBlock-orderefg--form{
		max-width: 1036px;
	...
	.mainBlock-orderefg--form .cBlock-orderefg--form{
		text-align: start;
	}

	.bodyClass3-orderefg--form .mainBlock-orderefg--form{
		background: none;
		border-top: 2px dashed #f7f3e9;
		border-bottom: 2px dashed #f7f3e9;
	}
	.bodyClass2-orderefg--form .mainBlock-orderefg--form{
		background: #070739;
		color: #fff !important;
		box-shadow: 0px 0px 15px #070739;
	}
	.bodyClass2-orderefg--form .mainBlock-orderefg--form p{
		color: #fff !important;
	}
	.bodyClass1-orderefg--form .mainBlock-orderefg--form{
		background: #122F14;
		color: #ffffff;
		border-left: 3px solid #321D2F;
	}
	.bodyClass1-orderefg--form .mainBlock-orderefg--form p{
...
<div class="bodyClass1-orderefg--form" id="mainWrapp-orderefg--form">


	<div class="wrapage-block-orderefg--form">
		<div class="box_main-orderefg--form">
			<div class="mainBlock-orderefg--form">
...
<p class="cBlock-orderefg--form">With heartfelt thanks and warm wishes!</p>
			</div>
		</div>
	</div>
        ...
        <footer class="footer-sp img-footernf">
            <div class="container-sp">
                <div class="ftop-sp">
                    <div class="footer-sp-item">
                        <a class="logo-link-sp" href="./">
                            <img class="logo-img" src="site-logo.png" width="37px" alt="">
                            Garbismicedio
                        </a>
                        <p class="footer-sp__text">At Garbismicedio, we breathe new life into your wardrobe through expert garment repair, precision tailoring, and personalized styling services tailored specifically to your unique personality and lifestyle needs.</p>
                    </div>
                ...
                <div class=" footer-sp-dec2">
                    ...
                    <circle opacity="0.8" cx="49.5" cy="49.5" r="49.5" fill="#006F5F"></circle>
                    </mask>
        ...
        <style>
            ...
            .hero-area-sp {
                position: relative;
                background-image: linear-gradient(to right, rgba(47, 48, 58, 0.4), rgba(47, 48, 58, 0.4)), url("assets/images/tailor-studio-background.webp");
            ...
            .textarea-form--group--input::placeholder {
                color: var(--text-color);
                font-size: 16px;
                line-height: 1.2;
            }
            ...
            .textarea-form--group--input:focus {
